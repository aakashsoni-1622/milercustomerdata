...
export async function POST(request: Request) {
  try {
    ...
    console.log("refunds", ordersData?.refunds[0]?.transactions);
    console.log("refunds", ordersData?.refunds[0]?.refund_line_items);
    console.log("refunds", JSON.stringify(ordersData?.refunds[0]));
    console.log("line_items", JSON.stringify(ordersData?.line_items));
    console.log("line_items", JSON.stringify(ordersData?.line_items[0]));
    console.log(
      "line_items",
      JSON.stringify(ordersData?.line_items[0]?.price_set)
    );
    console.log("line_items", ordersData?.line_items[0]?.price_set);
    ...
    return NextResponse.json({ results: "Test done" });
  } catch (error) {
